apikey = "";
      ...
      function initMap() {
        ...
        function optimizeRoutes() {
          ...
          console.log("Number of autocompletes: " + autocompletes.length);
          for (var i = 0; i < autocompletes.length; i++){
            var place = autocompletes[i].getPlace();
            var location = new Location(null, place);
            locations.push(location);
            console.log(location.place.name + " pushed to locations");
          }
          ...
          function AstarSearch(){
            ...
            console.log("Total locations length: " + originalLocationsLength);
            ...
            console.log(generateDirectionsURL());
            ...
            function search(currentLocation, neighbors){
              ...
              if (betterPath(currentLocation)){
                ...
                for (var i = 0; i < neighbors.length; i++){
                  ...
                  console.log("Level of " + child.place.name + " with parent " + currentLocation.place.name + ": " + child.level);
